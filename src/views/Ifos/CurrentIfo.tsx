    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy UNO and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get UNO-BNB LP tokens by adding UNO and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
          ...
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your UNO-LP tokens to buy the IFO tokens')}</li>
          </List>
