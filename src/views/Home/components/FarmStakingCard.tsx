...
const FarmedStakingCard = () => {
  ...
  const lpContract = useMemo(() => {
    return getContract(ethereum as provider, '0xA689A7f6c98E99C420f0e768854E6A47E48ed9d0');
  }, [ethereum])
      ...
      <CardBody>
        ...
        <Flex>
          ...
          <Button style={{marginRight:'15px'}}>
            <a href='https://octodex.UNOswap.com/#/swap?outputCurrency=0xA689A7f6c98E99C420f0e768854E6A47E48ed9d0'>
              {TranslateString(999, 'Buy UNO')}
            </a>
          </Button>
        ...
        <Block>
          <Label>{TranslateString(544, 'UNO to Harvest')}</Label>
        ...
        <Block>
          <Label>{TranslateString(546, 'UNO in Wallet')}</Label>
        ...
        <Actions>
          {account ? (
            ...
            >
              {pendingTx
                ? TranslateString(548, 'Collecting UNO')
